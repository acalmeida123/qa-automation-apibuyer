describe('Gerar e consultar cartões', () => {
  it('Deve gerar um cartão com todos os campos', () => {
    cy.createWithAllFields().then((response) => {
      expect(response.status).to.eq(201);
      
      console.log('VCN Gerado com sucesso:', getResponse.body);
